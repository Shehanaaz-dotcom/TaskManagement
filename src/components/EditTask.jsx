 ...
 setStatus('To Do')
  ...
  required/>
    ...
    <div className="mb-4" >
        ...
        className ="w-full px-3 border rounded-md focus:outline:none focus:ring:2 focus:ring:2"
>    <option value=""></option>
...
<div className="flex justify-between">
    ...
    <button
     type="submit"
    className ="bg-gray-300 text-white py-2 px-2 rounded-md" onClick={()=> setIsEditing(false)} >Cancel
        ...
        <button className ='px-3 py-1 bg-indigo-700 text-white rounded-md hover:bg-indigo-700'
